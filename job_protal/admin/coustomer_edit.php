        ...
        <div style="width: 60%; margin-left:20%;">
            ...
            <form action="coustomer_add.php" method="POST" style="margin: 3%; padding: 3%;" name="coustomer_from">
                <div class="form-group">
                    <label for="coustomer username"> Enter username</label>
                    <input type="username" name="username" id="uasername" class="form-control" placeholder=" Enter coustoner username">
                </div>
                <div class="form-group">
                    <label for="coustomer password"> Enter password</label>
                    <input type="passwrod" name="password" id="password" class="form-control" placeholder=" Enter coustoner password">
                </div>
                <div class="form-group">
